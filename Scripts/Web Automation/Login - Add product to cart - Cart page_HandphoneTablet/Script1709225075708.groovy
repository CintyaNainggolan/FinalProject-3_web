...
def categoryName = testData.getObjectValue('categoryName', 1)

WebUI.click(findTestObject('Object Repository/Kategori', [('categoryName') : categoryName]))

WebUI.click(findTestObject('Object Repository/jakmall.com/Page_Jual Handphone  Tablet  Jakmall.com/a_Lihat Semua Produk Handphone dan Tablet'))

WebUI.click(findTestObject('Object Repository/jakmall.com/Page_Jual Handphone  Tablet  Jakmall.com/a_OTOHEROES Smartphone Car Holder Adjustable with Suction Cup - T003'))
