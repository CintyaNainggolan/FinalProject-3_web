...
WebUI.click(findTestObject('Object Repository/jakmall.com/Page_Jual Elektronik  Jakmall.com/a_Taffware Antena TV Digital Indoor DVB-T2 25dB Grid Jack Male Plug - TFL-D139'))

WebUI.click(findTestObject('Object Repository/jakmall.com/Page_Jual Taffware Antena TV Digital Indoor DVB-T2 25dB Grid Jack/span_Tambah ke Keranjang'))

WebUI.click(findTestObject('Object Repository/jakmall.com/Page_Jual Taffware Antena TV Digital Indoor DVB-T2 25dB Grid Jack/a_Lihat keranjang'))
